                                ...
                                <div class="modal-body">
                                    <form action="{{ url('kriteria/tambah') }}" method="POST" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kode" id="" placeholder="Input field">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Nama Kriteria</label>
                                            <input type="text" class="form-control" name="nama_kriteria" id="" placeholder="Input field">
                                        </div>
                                        <div class="form-group">
