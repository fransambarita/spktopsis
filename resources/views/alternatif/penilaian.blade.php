                    ...
                    <form action="{{ url('alternatif/nilai_simpan') }}" method="POST" role="form">
                        ...
                        @foreach ($kriteria as $data)
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nilai_{{$data->id_kriteria}}" value="{{\App\Helper::nilai($alternatif->id_alternatif,$data->id_kriteria)}}" placeholder="Input field">
                            </div>
                        @endforeach
